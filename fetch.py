#!/usr/bin/env python3
"""
Recuperation des codes promo FRAM depuis shopilo.fr
Sursa: https://shopilo.fr/reductions/fram.fr
"""
...
SHOPILO_URL = "https://shopilo.fr/reductions/fram.fr"
STORE_NAME = "FRAM"


def fetch_coupons(url=SHOPILO_URL):
    """Renvoie la liste des coupons actifs pour FRAM depuis shopilo.fr"""
    headers = {
        "User-Agent": "Mozilla/5.0 (compatible; coupon-fetcher/1.0; +https://github.com/shopilo-fr/code-promo-fram)"
    }
    try:
